...
This is a companion repo for the [AI Agents Fundamentals, v2](https://frontendmasters.com/courses/ai-agents-v2/) course from [Frontend Masters](https://frontendmasters.com). 

### Course Notes

The course note can be found in this [Obsidian document](https://publish.obsidian.md/agents-v2/course).
